using Plots
"""
This script uses all the functions you need to implement for this assignment.
Submit the plot created by this script as part of your PDF submission (see instructions).
"""

# Include your completed code
include("assignment2_handout (1).jl")
...
p = plot(x, abs.(p_even .- cos.(ω * x)), label="Evenly-spaced Interpolation Error", color=:red)
